  ...
  return (
    <div className="container mt-5 py-5 align-items-center">
      <div className="container text-center mb-5">
        ...
        <display className="display-4 text-light mb-5">Crypto Currency Prices</display>
        <input type="text" onChange={(e) => setSearch(e.target.value)} className="form-control mt-4 bg-dark text-light" placeholder="Search a Crypto Currency" aria-label="Recipient's username" ></input>
      </div>
      {loading ?
